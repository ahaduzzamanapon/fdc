<nav class="navbar sticky-top navbar-expand-lg">
    <div class="container p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="z-index: 999999; background: white;">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-submenu2">
                            ...
                            <ul class="submenu2">
                                <li><a
                                        href="{{route('historyAndHeritageOfCinema.films_released_by_decade', ['decade' => '1960'])}}">৬০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('historyAndHeritageOfCinema.films_released_by_decade', ['decade' => '1970'])}}">৭০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('historyAndHeritageOfCinema.films_released_by_decade', ['decade' => '1980'])}}">৮০র
                                        দশক</a></li>
                                <li><a
                                        href="{{route('historyAndHeritageOfCinema.films_released_by_decade', ['decade' => '1990'])}}">৯০
                                        এর দশক</a></li>
                                <li><a
                                        href="{{route('historyAndHeritageOfCinema.films_released_by_decade', ['decade' => '2000'])}}">২০০০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('historyAndHeritageOfCinema.films_released_by_decade', ['decade' => '2010'])}}">২০১০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('historyAndHeritageOfCinema.films_released_by_decade', ['decade' => '2020'])}}">২০২০
                                        দশক</a></li>
                            </ul>
                        </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu">
                        <li class="has-submenu2">
                            ...
                            <ul class="submenu2">
                                <li><a
                                        href="{{route('filmsPhotoGallery.films_photo_by_decade', ['decade' => '1960'])}}">৬০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('filmsPhotoGallery.films_photo_by_decade', ['decade' => '1970'])}}">৭০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('filmsPhotoGallery.films_photo_by_decade', ['decade' => '1980'])}}">৮০র
                                        দশক</a></li>
                                <li><a
                                        href="{{route('filmsPhotoGallery.films_photo_by_decade', ['decade' => '1990'])}}">৯০
                                        এর দশক</a></li>
                                <li><a
                                        href="{{route('filmsPhotoGallery.films_photo_by_decade', ['decade' => '2000'])}}">২০০০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('filmsPhotoGallery.films_photo_by_decade', ['decade' => '2010'])}}">২০১০
                                        দশক</a></li>
                                <li><a
                                        href="{{route('filmsPhotoGallery.films_photo_by_decade', ['decade' => '2020'])}}">২০২০
                                        দশক</a></li>
                            </ul>
                        </li>
                        <li><a class="nav-link" href="{{ route('photo_gallery.page') }}">ফটোগ্যালারী</a></li>
                    </ul>
                </li>
