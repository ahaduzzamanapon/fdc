...
<div class="card-body table-responsive">
    ...
    <form id="filmReportFilter" class="row g-3 mb-4 align-items-end">
        ...
        <div class="col-md-6">
            <label for="organization" class="form-label">{{ __('প্রামান্য চিত্রের নাম') }}</label>
            <input type="text" id="organization" name="organization" class="form-control" placeholder="{{ __('প্রামান্য চিত্রের নাম...') }}">
        </div>
