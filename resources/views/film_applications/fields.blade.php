...
<fieldset class="border p-3 mb-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="film_serial_no" name="film_serial_no" required>
        </div>
        <div class="col-md-4 mb-3">
        ...
        <div class="mb-3 col-md-4">
            ...
            <input type="number" class="form-control" id="film_duration" name="film_duration" placeholder="{{ __('messages.enter_duration_in_minutes') }}" required>
        </div>
    </div>
</fieldset>
...
<fieldset class="border p-3 mb-4">
    ...
    <div class="row">
        <div class="mb-3 col-md-4">
            ...
            <input type="text" class="form-control" id="set_design" name="set_design" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="equipment_rental" class="form-label">{{ __('messages.equipment_rental') }}</label>
            <input type="text" class="form-control" id="equipment_rental" name="equipment_rental" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="editing" class="form-label">{{ __('messages.editing') }}</label>
            <input type="text" class="form-control" id="editing" name="editing" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="color_grading" class="form-label">{{ __('messages.color_grading') }}</label>
            <input type="text" class="form-control" id="color_grading" name="color_grading" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="vfx" class="form-label">{{ __('messages.vfx') }}</label>
            <input type="text" class="form-control" id="vfx" name="vfx" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="digital_camera" class="form-label">{{ __('messages.digital_camera') }}</label>
            <input type="text" class="form-control" id="digital_camera" name="digital_camera" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="digital_lab" class="form-label">{{ __('messages.digital_lab') }}</label>
            <input type="text" class="form-control" id="digital_lab" name="digital_lab" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="approx_cost_general" class="form-label">{{ __('messages.estimated_cost_general') }}</label>
            <input type="number" class="form-control" id="approx_cost_general" name="approx_cost_general" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="approx_cost_animation" class="form-label">{{ __('messages.estimated_cost_animation') }}</label>
            <input type="number" class="form-control" id="approx_cost_animation" name="approx_cost_animation" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="approx_cost_shortfilm" class="form-label">{{ __('messages.estimated_cost_short_film') }}</label>
            <input type="number" class="form-control" id="approx_cost_shortfilm" name="approx_cost_shortfilm" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="approx_cost_others" class="form-label">{{ __('messages.estimated_cost_others') }}</label>
            <input type="number" class="form-control" id="approx_cost_others" name="approx_cost_others" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="film_type" class="form-label">{{ __('messages.film_type') }}</label>
            <input type="text" class="form-control" id="film_type" name="film_type" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="org_type" class="form-label">{{ __('messages.organization_type') }}</label>
            <input type="text" class="form-control" id="org_type" name="org_type" required>
        </div>
        <div class="mb-3 col-md-4">
        ...
        <div class="mb-3 col-md-12">
            ...
            <textarea class="form-control" id="freedom_film_info" name="freedom_film_info" rows="2" required></textarea>
        </div>
        <div class="mb-3 col-md-12">
            <label for="previous_films_info" class="form-label">{{ __('messages.previous_films_info') }}</label>
            <textarea class="form-control" id="previous_films_info" name="previous_films_info" rows="2" required></textarea>
        </div>
        <div class="mb-3 col-md-4">
            <label for="board_member_status" class="form-label">{{ __('messages.board_member_responsibility') }}</label>
            <input type="text" class="form-control" id="board_member_status" name="board_member_status" required>
        </div>
        <div class="mb-3 col-md-4">
        ...
        <div class="mb-3 col-md-4">
            ...
            <input type="text" class="form-control" id="director_nid" name="director_nid" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="cameraman_name" class="form-label">{{ __('messages.cameraman_name') }}</label>
            <input type="text" class="form-control" id="cameraman_name" name="cameraman_name" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="main_cast" class="form-label">{{ __('messages.main_character') }}</label>
            <input type="text" class="form-control" id="main_cast" name="main_cast" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="foreign_participation" class="form-label">{{ __('messages.foreign_participation') }}</label>
            <input type="text" class="form-control" id="foreign_participation" name="foreign_participation" required>
        </div>
        <div class="mb-3 col-md-4">
            <label for="script_writer_name" class="form-label">{{ __('messages.scriptwriter_name') }}</label>
            <input type="text" class="form-control" id="script_writer_name" name="script_writer_name" required>
        </div>
    </div>
</fieldset>
...
<fieldset class="border p-3 mb-4">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="file" class="form-control" id="nid_file" name="nid_file" accept=".pdf,.jpg,.jpeg,.png" required>
        </div>
        <div class="col-md-3 mb-3">
...
<fieldset class="border p-3 mb-4">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="organization_address" name="organization_address" rows="2" required></textarea>
    </div>
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="bank_account_info" name="bank_account_info" rows="2" required></textarea>
    </div>
</fieldset>
...
<div class="form-group col-sm-12" style="text-align-last: right;">
    ...
    <button type="submit"
            ...
            formaction="{{ route('filmApplications.film.save.draft') }}"
            formmethod="POST">
