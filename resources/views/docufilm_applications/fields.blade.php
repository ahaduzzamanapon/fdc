<!-- Section: ডকুফিল্ম সংক্রান্ত তথ্য -->
<fieldset class="border p-3 mb-4">
    <legend class="float-none w-auto px-2">{{ __('ডকুফিল্ম সংক্রান্ত তথ্য') }}</legend>
    <div class="row">

        <input type="hidden" id="category" name="category" value="docufilm">
        <div class="mb-3 col-md-8">
            <label for="film_title" class="form-label">{{ __('messages.name_of_produced_pl_advertisement') }}</label>
            <input type="text" class="form-control" id="film_title" name="film_title">
        </div>


        <div class="col-md-4 mb-3">
            <label for="film_serial_no" class="form-label">{{ __('messages.applied_pl_number') }}</label>
...
<!-- Section: অতিরিক্ত ডকুফিল্ম সংক্রান্ত তথ্য -->
<fieldset class="border p-3 mb-4">
    <legend class="float-none w-auto px-2">{{ __('অতিরিক্ত ডকুফিল্ম সংক্রান্ত তথ্য') }}</legend>
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-4">
            <label for="film_type" class="form-label">{{ __('ডকুফিল্ম ধরন') }}</label>
        ...
        <div class="mb-3 col-md-12">
            <label for="freedom_film_info" class="form-label">{{ __('মুক্তিযুদ্ধ বিষয়ক ডকুফিল্ম হলে বিস্তারিত তথ্য') }}</label>
            <textarea class="form-control" id="freedom_film_info" name="freedom_film_info" rows="2"></textarea>
        </div>
        <div class="mb-3 col-md-12">
            <label for="previous_films_info" class="form-label">{{ __('পূর্বে নির্মিত ডকুফিল্ম সম্পর্কিত তথ্য') }}</label>
