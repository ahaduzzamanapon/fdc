                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="{{ route('docufilmApplications.show', [$film->id]) }}" class="dropdown-item"><i
                                        class="im im-icon-Eye" data-placement="top"
                                        title="{{ __('messages.view_label') }}"></i> {{ __('messages.view_label') }}</a>

                                {{--For draft edit--}}
                                @if($film->status == 'draft')
                                    <a href="{{ route('docufilmApplications.doc.edit.draft', [Crypt::encrypt($film->id)]) }}"
                                ...
                                @if ($film->status == 'on process' && !Auth::guard('producer')->check())
                                    <a href="{{ route('docufilmApplications.forward', [$film->id, 'additional_director_finance']) }}"
