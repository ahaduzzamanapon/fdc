{!! Form::open(['route' => 'producer.registration.forward.st','class' => 'form-horizontal col-md-12']) !!}
    <!-- Section: Form -->
    <fieldset class="border p-3 mb-4">
        <legend class="float-none w-auto px-2">তথ্য হাল নাগাদ করুন</legend>
        <input type="hidden" name="reg_id" value="@php echo $producer->id; @endphp">
        <div class="row">
            <div class="col-12">
                ...
                <input type="radio" name="reg_status" value="verified"> <span>অনুমোদন</span>
                <input type="radio" name="reg_status" value="rejected"> <span>প্রত্যাখ্যান</span>
            </div>
