...
<body
  style="height: 100vh;background:  url('{{ asset('images/bg.jpg') }}') center center / cover no-repeat;width: 100vw;overflow: hidden;">
      ...
      <div style="padding: 40px 30px;">
        ...
        <form action="{{ route('login') }}" method="POST">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="email" placeholder="মোবাইল/ইমেইল" required>
          </div>
          <br>
          <p
            style="justify-self: left;font-family: 'Noto Sans Bengali', sans-serif;font-weight: 600;font-size: 16px;line-height: 100%;vertical-align: middle;">
