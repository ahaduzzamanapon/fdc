                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            @if($film->status == 'draft')
                                <a href="{{ route('filmApplications.film.edit.draft', [Crypt::encrypt($film->id)]) }}" class="dropdown-item"><i class="im im-icon-Eye" data-placement="top" title="View"></i> Edit Draft</a>
                            @endif
