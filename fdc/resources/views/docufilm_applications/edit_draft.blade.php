...
@section('title')
    Documentary Application {{ __('messages.film_application') }} @parent
@stop
@section('content')
    <div class="content">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <form action="{{ route('docufilmApplications.doc.update.draft') }}" method="POST" enctype="multipart/form-data">
                        @csrf
